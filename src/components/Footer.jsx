            ...
            <Container fixed="bottom">
                <div className="row">
                    <div className="col-lg-12">
                        <p> <img src={logo} style={{width:"50px"}}/> Copyright © 2025 Queens English Institute</p>
                    </div>
                </div>
                <Container className="ms-3" style={{marginTop:"-35px"}}><img src={cambridge} style={{width:"230px"}}/></Container>
