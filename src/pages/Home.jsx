...
import academy from '../assets/images/banner-right-image.png'
...
function Home() {
    ...
    <Container>
      <SubNavHome/>
        ...
        <div className="container">
            ...
            <div className="col-lg-12">
                ...
                <div className="col-lg-6 align-self-center">
                    ...
                    <p>
                        Ofrecemos clases desde B1 hasta C1 con profesores nativos.
       ...
       <div className="mb-3" id="profesores"><Profesores/></div>
       <div className="mb-3" id="map"><Map/></div>
